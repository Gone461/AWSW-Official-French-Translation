...
# game/anna5.rpy:12
translate french anna5_82ee252e:
...
translate french anna5_297bd20d:
    ...
    c "Avec un argument comme celui-ci, on pourrait juste rester ici tu sais."
...
translate french anna5_20e2d7dc:
    ...
    c "Autant dire que tout la ville est sortie pour regarder le feu d'artifice."

# game/anna5.rpy:50
translate french anna5_fd08d2f0:

    # An face "Yeah, I'm not going to those places. I'm kind of a celebrity, you know."
    An face "Oui, mais je ne vais pas me mélanger à eux. Je suis une sorte de célébrité ici, tu sais."

# game/anna5.rpy:52
translate french anna5_4e24c2ca:

    # c "Really?"
    c "Ah oui ?"

# game/anna5.rpy:54
translate french anna5_b493401c:

    # An sad "For better or worse, people know about me. Of course they would, given my intellectual status."
    An sad "Oui la plupart des gens me connaissent, que ce soit pour le meilleur ou pour le pire."
...
translate french anna5_91355740:
    ...
    c "Anna, on doit partir, maintenant."
...
translate french _call_endingjustafewminuteslater_1_40a50c3c:
    ...
    Rz angry "C'était ton plan ça, n'est-ce pas, [player_name] ?"
...
translate french _call_endingjustafewminuteslater_1_b783d092:
    ...
    m "Maverick fut rapide à se jeter sur Reza, ce dernier n'eut même pas le temps de viser l'un d'entre nous."
...
translate french _call_endingjustafewminuteslater_1_3305fa38:
    ...
    m "Le dragon poussa Reza au sol, avant d'enfoncer ses dents dans son corps."
...
translate french _call_endingjustafewminuteslater_1_b5f736a1:
    ...
    m "Reza hurlait. Il visa la tête de Maverick et appuya sur la détente à deux reprises."
...
translate french _call_endingjustafewminuteslater_1_98a8dd49:
    ...
    m "Les mâchoires se relâchèrent, Reza en profita aussitôt pour pointer son arme dans ma direction. C'est alors qu'Anna bondit à son tour alors que j'entendais plusieurs déflagrations assourdissantes."
...
translate french _call_endingjustafewminuteslater_1_f7bc135f:
    ...
    m "Reza l'a regardée, surpris, avant de s'enflammer instantannément."
...
translate french _call_endingjustafewminuteslater_1_d7961dd8:
    ...
    An "Je sais que tu peux accomplir la mission dans laquelle tu t'es lancée. Même si moi je n'en suis pas capable."
...
translate french _call_endingjustafewminuteslater_1_cefce0e4:
    ...
    Iz "Malheureusement, ça ne va pas être possible."
...
translate french _call_endingjustafewminuteslater_1_4cc00571:
    ...
    c "Mais le portail a bien un moyen de localiser d'autres portails en état de marche, non ? On peut rétablir la connection !"
...
translate french _call_endingjustafewminuteslater_1_2f3bd6e1:
    ...
    m "Lorsque je me suis rendu compte qu'Izumi avait le revolver de Reza dans la main, je me suis empressé de la saisir pour rester hors de portée avant qu'elle n'appuie sur la détente."
...
translate french _call_syscheck_42_e7760f77:
    ...
    s "Vous avez vu la mauvaise fin d'Anna."
...
translate french annagoodending_1ff8ac61:
    ...
    m "Nous sommes allé voir les autres, mais Maverick comme l'Administrateur étaient morts."

# game/anna5.rpy:779
translate french annagoodending_76b2fe88:
...
translate french annagoodending_0d4277f6:
    ...
    n "Bien qu'ils aient remis le portail en marche, je savais qu'il m'était impossible de retourner auprès des miens car l'Administrateur, Izumi, avait volontairement supprimé les coordonnées de mon monde en réparant le portail."
...
# game/anna5.rpy:799
translate french annagoodending_47822293:
    ...
    n "Ce ne fut pas au centre de mes préocuppations cependant. Je restais le plus possible avec Anna, ne voulant la laisser seul dans son voyage."
...
translate french annagoodending_e0479f7f:
    ...
    n "Elle étant entrée dans une maison de repos, et était devenu mince et faible, la maladie l'usant physiquement et mentalement."

# game/anna5.rpy:811
translate french annagoodending_76b2fe88_2:

    # nvl clear
    nvl clear

# game/anna5.rpy:819
translate french annagoodending_c8720a47:

    # c "What did the doctor say?"
    c "Qu'est-ce que le docteur en dit ?"
